...
const ImageUpload = ({ onImageUpload, currentImageUrl = '', disabled = false }) => {
  ...
  const handleFileUpload = async (file) => {
    ...
    if (!canUpload) {
      setError('Only the owner or super admin can upload images')
      return
    }
    ...
    try {
      ...
      // Upload to Cloudinary via Supabase Edge Function
        ...
        >
          {uploading ? (
            ...
            <div className="image-upload__content">
              <Icon name="image" size={48} className="image-upload__icon" />
